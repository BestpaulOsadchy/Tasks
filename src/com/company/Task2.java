...
public class Task2 {
    public static void main(String[] args) {
        System.out.println(repeat("kd2",4));
        int[] mas = {2, 4, 6};
        System.out.println(differenceMaxMin(mas));
        System.out.println(isAvgWhole(mas));
        mas = cumulativeSum(mas);
        System.out.println(mas[0] + " " + mas[1] + " " + mas[2]);
        System.out.println(getDecimalPlaces("383.2934"));
        System.out.println(Fibonacci(4));
        System.out.println(isValid("30907"));
        System.out.println(isStrangePair("word1","word2"));
        System.out.println(isPrefix("prefix","pre"));
        System.out.println(isSuffix("suffix","fix"));
