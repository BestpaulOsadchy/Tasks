...
public class Task4 {
    public static void main(String[] args) {
        System.out.println(Bessy(10, 8, "fjjjrj  rjrjj rhhr sqjqe ke djek"));
        System.out.println();
        String[] st = split("((())())()(())");
        System.out.println(st[0]);
        System.out.println(toCamelCase("kddkK_jfjnfr"));
        System.out.println(toSnakeCase("kdKsss_jnfr"));
        System.out.println(BMI("80", "1.80"));
        System.out.println(bugger(47));
        System.out.println(doesRhyme("kfka", "dkkda"));
        System.out.println(toStarShorthand("kekeekk"));
        System.out.println(trouble(484823, 84848));
