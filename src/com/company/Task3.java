...
public class Task3 {
    public static void main(String[] args) {
        System.out.println(solutions(3, 4, 5));
        System.out.println(findZip("fjfstrkdkkdstrlflfstr"));
        System.out.println(checkPerfect(111));
        System.out.println(flipEndChars("jh"));
        System.out.println(isValidHexCode("#AFEF72"));
        int[] mas = {2, 4, 6};
        int[] mas2 = {6, 28, 8};
        System.out.println(same(mas,mas2));
        System.out.println(isKaprekar(9));
        System.out.println(longestZero("84840000384848400273737000002288282882"));
        System.out.println(nextPrime(65));
