...
public class Task1 {
    public static void main(String[] args) {
        System.out.println(remainder(40, 7));
        System.out.println(triArea(3, 4));
        System.out.println(animal(5, 3, 1));
        System.out.println(profitableGamble(4, 6, 0));
        System.out.println(operation(6, 18, 3));
        System.out.println(ctoa('o'));
        System.out.println(addUpTo(20));
        System.out.println(nextEdge(20, 39));
        int[] nums = { 1, 2, 3, 5 };
        System.out.println(sumOfCubes(nums));
        System.out.println(abcmath(4,6,3));
    }
